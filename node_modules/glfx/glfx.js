...
var fx = (function() {
  ...
  function y(a) {
    ...
    a = a[8];
    var f =
      d * n * a - d * l * m - c * g * a + c * l * p + e * g * m - e * n * p;
    return [
      (n * a - l * m) / f,
      (e * m - c * a) / f,
      (c * l - e * n) / f,
  ...
  var h = (function() {
      function b(b, c) {
        ...
        if (!a.getShaderParameter(d, a.COMPILE_STATUS))
          throw "compile error: " + a.getShaderInfoLog(d);
        return d;
      }
      function d(d, f) {
        ...
        for (var c in b)
          if (b.hasOwnProperty(c)) {
            ...
            if (null !== d) {
              ...
              else if ("[object Number]" == Object.prototype.toString.call(e))
                a.uniform1f(d, e);
              else
      ...
      d.prototype.drawRect = function(b, c, d, e) {
        ...
        a.bufferData(
          a.ARRAY_BUFFER,
          new Float32Array([b, c, b, e, d, c, d, e]),
          a.STATIC_DRAW
        );
